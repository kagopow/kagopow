...
These are the dependencies currently used by kagopow. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/kagopownl
Keybase  - https://keybase.io/team/kagopow/
