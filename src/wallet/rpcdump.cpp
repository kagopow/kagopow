...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"kagopowaddress\"\n"
            "\nReveals the private key corresponding to 'kagopowaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"kagopowaddress\"   (string, required) The kagopow address for the private key\n"
            "\nResult:\n"
