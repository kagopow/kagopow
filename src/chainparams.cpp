...
public:
    CMainParams() {
        ...
        //vSeeds.push_back(CDNSSeedData("kagopow.org", "node2.kagopow.org"));
        //vSeeds.push_back(CDNSSeedData("n2.kagopow.org", "secondnode.kagopow.org"));
        ...
        checkpointData = (CCheckpointData) {
                    ...
                    3843,    // * total number of transactions between genesis and last checkpoint
