...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/kagopow/kagopow>";
    const std::string URL_WEBSITE = "<https://kagopow.org/>";
    // todo: remove urls from translations on next change

    return FormatParagraph(strprintf("Copyright (C) %i The KAGOPOW Developers", COPYRIGHT_YEAR)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find kagopow useful. "
