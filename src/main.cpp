...
#if defined(NDEBUG)
# error "kagopow cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "kagopow Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // kagopow also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // kagopow also requires low S in sigs
