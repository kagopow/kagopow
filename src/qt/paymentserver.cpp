...
const QString BITCOIN_IPC_PREFIX("kagopow:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/kagopow-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/kagopow-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/kagopow-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click kagopow: links
...
//
// OSX-specific way of handling kagopow: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in kagopow: URIs
